...
%% DEFINE MODEL
modelFileName = 'E:\github_jh\jh_hub\sfers\2025-1 sfers macro2\haberis(2019)_modified_real\Models\bgg_ver1.maps';

%% INFO ABOUT LOSS FUNCTION
objVarMnems = {'pie';'y'};    
objVarWeights = [1; 0.025/10];
beta = 0.99;
...
saveFileName = [thisDir,'Results\withoutfinancial.mat'];

...
%% DEFINE MODEL
modelFileName = '/MATLAB Drive/새 폴더/virgil/Models/fiscal3.maps';

%% INFO ABOUT LOSS FUNCTION
objVarMnems = {'pie';'y'; 'y-d'};    
objVarWeights = [1; 0.025/10]; 1.4; % lambda = kappa/theta
beta = 0.99;
...
shockMnem = 'etarn';
shockSize = -80/4;
nLFLperiods = 5;                       % Liftoff in period 11 case
...
pLFLkPlus1 = [0,0,0,0.0531,0.2878,0.3449];

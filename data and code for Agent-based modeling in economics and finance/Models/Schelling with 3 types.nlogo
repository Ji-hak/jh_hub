...
to setup
  clear-all
  ; Initialize the RNG and display the seed
  let seed -1013275810; new-seed
  random-seed seed
  show seed
  ...
  ask patches [
    ...
    if random 100 < density [   ; set the occupancy density
      sprout 1 [
        ; 108 is the color number for "light blue"
        ; 57 is "green"
        ; 27 is "orange"
        set color one-of [108 108 108 108 108 108 108 108 108 108 108 108 108 108 108 57 57 57 57 27]
        set size 1
      ]
    ]
  ]
